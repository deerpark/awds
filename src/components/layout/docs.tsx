    ...
    <div className="flex-1 mx-auto flex w-full max-w-7xl items-start gap-x-8 px-4 py-10 sm:px-6 lg:px-8">
      ...
      <main className="flex-1 flex flex-col">
        <div className="flex flex-centered flex-1 flex-col">
          <div className="container flex flex-1 flex-col">
            <div className="flex flex-1 flex-col">
              <h2 className="flex-none text-2xl text-slate-900 dark:text-slate-100 capitalize">
        ...
        <div className="flex-none flex-centered">
          <div className="container py-10 flex-centered text-xs text-slate-300 dark:text-slate-700">
            &copy; DT Hub
          </div>
        </div>
      </main>
